...
$config['message_start_delimiter'] = '<div class="alert alert-warning" role="alert">'; 	// Message start delimiter
$config['message_end_delimiter']   = '</div>'; 	// Message end delimiter
$config['error_start_delimiter']   = '<div class="alert alert-warning" role="alert">';		// Error message start delimiter

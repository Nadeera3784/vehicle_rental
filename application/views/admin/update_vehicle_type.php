                ...
                <div class="card">
                    ...
                    <div class="body">
                       <?php $attr = array("id" => "add_client_form", "novalidate" => "novalidate");?>
                        <?php echo form_open('admin/save_vehicle_type', $attr);?>
                            <div class="form-group row">
                                <label for="title" class="col-sm-2 col-form-label">Title</label>
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" name="title" id="title" autocomplete="off" value="<?php echo $vehicle_type->title;?>">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <textarea class="form-control" type="text" name="description" id="description" autocomplete="off"><?php echo $vehicle_type->description;?></textarea>
                                    <?php echo form_error('description'); ?>
                                </div>
                            </div>
                            <div class="form-group row">
                                <div class="col-sm-10 offset-sm-2">
                                        <input type="hidden" name="id" id="id"  value="<?php echo  $this->hasher->encrypt($vehicle_type->vehicle_type_id) ;?>">

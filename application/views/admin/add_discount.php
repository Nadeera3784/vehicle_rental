       ...
       <div class="row">
           <div class="col-md-12 animate-element">
                <div class="card">
                    ...
                    <div class="body">
                        <?php echo form_open('admin/add_discount');?>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                <input type="number" class="form-control" name="limit" id="limit" autocomplete="off" value="<?php echo $this->form_validation->set_value('limit');?>">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                <input type="text" class="form-control" name="pcode" id="pcode" autocomplete="off" value="<?php echo $this->form_validation->set_value('pcode');?>">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                <input type="number" class="form-control" name="discount" id="discount" autocomplete="off" value="<?php echo $this->form_validation->set_value('discount');?>">

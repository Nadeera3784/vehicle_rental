...
!function(e, t) {
    ...
    var te = function(e) {
      ...
      , b = {
        ...
        K: function(e, t, n) {
            e.setHours(e.getHours() % 12 + 12 * X(new RegExp(n.amPM[1],"i").test(t)))
        },
        M: function(e, t, n) {
      ...
      , l = {
        ...
        K: function(e, t) {
            return t.amPM[X(11 < e.getHours())]
        },
        M: function(e, t) {
            return ne(e.getMonth(), !0, t)
        },
        S: function(e) {
      ...
      , oe = function(e) {
        ...
        return function(a, e, t) {
            if (void 0 !== o.formatDate)
                return o.formatDate(a, e);
            var i = t || r;
    ...
    function r(u, f) {
        var h = {
            config: Object.assign({}, pe.defaultConfig),
            l10n: ie
        };
        function m(e) {
            return e.bind(h)
            ...
            if (0 !== h.selectedDates.length) {
                void 0 !== e && "blur" !== e.type && function(e) {
                    ...
                    var t = "keydown" === e.type
                      , n = e.target;
                    void 0 !== h.amPM && e.target === h.amPM && (h.amPM.textContent = h.l10n.amPM[X(h.amPM.textContent === h.l10n.amPM[0])]);
                    ...
                    if (void 0 !== n.value && 2 === n.value.length) {
                        var d = n === h.hourElement
                          , s = n === h.minuteElement;
                        c < a ? (c = i + c + X(!d) + (X(d) && X(!h.amPM)),
                        s && v(void 0, -1, h.hourElement)) : i < c && (c = n === h.hourElement ? c - i - X(!h.amPM) : a,
                        s && v(void 0, 1, h.hourElement)),
                        h.amPM && d && (1 === o ? c + r === 23 : Math.abs(c - r) > o) && (h.amPM.textContent = h.l10n.amPM[X(h.amPM.textContent === h.l10n.amPM[0])]),
                        n.value = Q(c)
                    }
                }(e);
        ...
        function p() {
            if (void 0 !== h.hourElement && void 0 !== h.minuteElement) {
                ...
                n = e % 12 + 12 * X(t === h.l10n.amPM[1]));
                var o = void 0 !== h.config.minTime || h.config.minDate && h.minDateHasTime && h.latestSelectedDateObj && 0 === le(h.latestSelectedDateObj, h.config.minDate, !0);
                if (void 0 !== h.config.maxTime || h.config.maxDate && h.maxDateHasTime && h.latestSelectedDateObj && 0 === le(h.latestSelectedDateObj, h.config.maxDate, !0)) {
        ...
        function c(e, t, n) {
            ...
            h.hourElement && h.minuteElement && !h.isMobile && (h.hourElement.value = Q(h.config.time_24hr ? e : (12 + e) % 12 + 12 * X(e % 12 == 0)),
            h.minuteElement.value = Q(t),
            void 0 !== h.amPM && (h.amPM.textContent = h.l10n.amPM[X(12 <= e)]),
            void 0 !== h.secondElement && (h.secondElement.value = Q(n)))
        }
        function n(e) {
        ...
        function D(e, t, n, a) {
            var i, o = N(t, !0), r = ue("span", "flatpickr-day " + e, t.getDate().toString());
            return r.dateObj = t,
            r.$i = a,
            r.setAttribute("aria-label", h.formatDate(t, h.config.ariaDateFormat)),
            -1 === e.indexOf("hidden") && 0 === le(t, h.now) && ((h.todayDateElem = r).classList.add("today"),
            r.setAttribute("aria-current", "date")),
            o ? (r.tabIndex = -1,
            z(t) && (r.classList.add("selected"),
            h.selectedDateElem = r,
            "range" === h.config.mode && (se(r, "startRange", h.selectedDates[0] && 0 === le(t, h.selectedDates[0], !0)),
            se(r, "endRange", h.selectedDates[1] && 0 === le(t, h.selectedDates[1], !0)),
            "nextMonthDay" === e && r.classList.add("inRange")))) : r.classList.add("disabled"),
            "range" === h.config.mode && (i = t,
            !("range" !== h.config.mode || h.selectedDates.length < 2) && 0 <= le(i, h.selectedDates[0]) && le(i, h.selectedDates[1]) <= 0 && !z(t) && r.classList.add("inRange")),
        ...
        function C(e, t) {
            var n = F(document.activeElement)
              , a = void 0 !== e ? e : n ? document.activeElement : void 0 !== h.selectedDateElem && F(h.selectedDateElem) ? h.selectedDateElem : void 0 !== h.todayDateElem && F(h.todayDateElem) ? h.todayDateElem : b(0 < t ? 1 : -1);
        ...
        function y() {
            if (void 0 !== h.daysContainer) {
                fe(h.daysContainer),
                h.weekNumbers && fe(h.weekNumbers);
                for (var e = document.createDocumentFragment(), t = 0; t < h.config.showMonths; t++) {
                    ...
                    e.appendChild(M(n.getFullYear(), n.getMonth()))
                }
        ...
        function T() {
            h.weekdayContainer ? fe(h.weekdayContainer) : h.weekdayContainer = ue("div", "flatpickr-weekdays");
            for (var e = h.config.showMonths; e--; ) {
        ...
        function N(e, t) {
            ...
            if (h.config.minDate && n && le(n, h.config.minDate, void 0 !== t ? t : !h.minDateHasTime) < 0 || h.config.maxDate && n && 0 < le(n, h.config.maxDate, void 0 !== t ? t : !h.maxDateHasTime))
                return !1;
        ...
        function A(e) {
            ...
            if (13 === e.keyCode && t) {
                ...
                case 40:
                    ...
                    h.daysContainer ? e.ctrlKey ? (_(h.currentYear - l),
                    C(b(1), 0)) : o || C(void 0, 7 * l) : h.config.enableTime && (!o && h.hourElement && h.hourElement.focus(),
                    g(e),
                    h._debouncedChange());
                    break;
                case 9:
        ...
        function P(o) {
            if (1 === h.selectedDates.length && (!o || o.classList.contains("flatpickr-day") && !o.classList.contains("disabled"))) {
                for (var r = o ? o.dateObj.getTime() : h.days.firstElementChild.dateObj.getTime(), l = h.parseDate(h.selectedDates[0], void 0, !0).getTime(), e = Math.min(r, h.selectedDates[0].getTime()), t = Math.max(r, h.selectedDates[0].getTime()), n = h.daysContainer.lastChild.lastChild.dateObj.getTime(), c = !1, d = 0, s = 0, a = e; a < n; a += de.DAY)
                ...
                for (var u = 0; u < h.config.showMonths; u++)
                    for (var f = h.daysContainer.children[u], m = h.daysContainer.children[u - 1], i = function(e, t) {
                        ...
                        d <= a && (0 === s || a <= s) && ce(a, l, r) && n.classList.add("inRange")))))
        ...
        function H() {
            "object" != typeof h.config.locale && void 0 === pe.l10ns[h.config.locale] && h.config.errorHandler(new Error("flatpickr: invalid locale " + h.config.locale)),
            h.l10n = Object.assign({}, pe.l10ns.default, "object" == typeof h.config.locale ? h.config.locale : "default" !== h.config.locale ? pe.l10ns[h.config.locale] : void 0),
            ae.K = "(" + h.l10n.amPM[0] + "|" + h.l10n.amPM[1] + "|" + h.l10n.amPM[0].toLowerCase() + "|" + h.l10n.amPM[1].toLowerCase() + ")",
            h.formatDate = oe(h),
            h.parseDate = re({
                config: h.config,
                l10n: h.l10n
        ...
        function L(e) {
            if (void 0 !== h.calendarContainer) {
                ...
                if (se(h.calendarContainer, "arrowTop", !d),
                se(h.calendarContainer, "arrowBottom", d),
                !h.config.inline) {
                    ...
                    se(h.calendarContainer, "rightMost", m),
        ...
        function K(e) {
            ...
            if (void 0 !== t) {
                ...
                "single" === h.config.mode)
                    ...
                    0 !== le(a, h.selectedDates[0], !0) && h.selectedDates.sort(function(e, t) {
                ...
                i || "range" === h.config.mode || 1 !== h.config.showMonths ? h.selectedDateElem && h.selectedDateElem.focus() : w(n),
        ...
        h.destroy = function() {
            ...
            h.mobileInput)
                ...
                if (h.config.static && h.calendarContainer.parentNode) {
                    ...
                    for (n.lastChild && n.removeChild(n.lastChild); n.firstChild; )
        ...
        h.set = function(e, t) {
            ...
            void 0 !== J[e] && J[e].forEach(function(e) {
                return e()
            }));
            h.redraw(),
            l()
        ...
        function G() {
            h.config.noCalendar || h.isMobile || !h.monthNav || (h.yearElements.forEach(function(e, t) {
                var n = new Date(h.currentYear,h.currentMonth,1);
                n.setMonth(h.currentMonth + t),
                h.monthElements[t].textContent = ne(n.getMonth(), h.config.shorthandCurrentMonth, h.l10n) + " ",
        ...
        function V(e) {
            ...
            void 0 !== h.altInput && (h.altInput.value = h.selectedDates.map(function(e) {
        ...
        return function() {
            ...
            function() {
                var e = ["wrap", "weekNumbers", "allowInput", "clickOpens", "time_24hr", "enableTime", "noCalendar", "altInput", "shorthandCurrentMonth", "inline", "static", "enableSeconds", "disableMobile"]
                  ...
                  , n = Object.assign({}, f, JSON.parse(JSON.stringify(u.dataset || {})))
                  , a = {};
                h.config.parseDate = n.parseDate,
                h.config.formatDate = n.formatDate,
                ...
                var i = "time" === n.mode;
                n.dateFormat || !n.enableTime && !i || (a.dateFormat = n.noCalendar || i ? "H:i" + (n.enableSeconds ? ":S" : "") : pe.defaultConfig.dateFormat + " H:i" + (n.enableSeconds ? ":S" : "")),
                n.altInput && (n.enableTime || i) && !n.altFormat && (a.altFormat = n.noCalendar || i ? "h:i" + (n.enableSeconds ? ":S K" : " K") : pe.defaultConfig.altFormat + " h:i" + (n.enableSeconds ? ":S" : "") + " K"),
                ...
                "time" === n.mode && (h.config.noCalendar = !0,
                h.config.enableTime = !0),
                Object.assign(h.config, a, n);
                for (var r = 0; r < e.length; r++)
                    h.config[e[r]] = !0 === h.config[e[r]] || "true" === h.config[e[r]];
                for (var l = t.length; l--; )
                    void 0 !== h.config[t[l]] && (h.config[t[l]] = te(h.config[t[l]] || []).map(m));
                ...
                for (var c = 0; c < h.config.plugins.length; c++) {
                    var d = h.config.plugins[c](h) || {};
                    for (var s in d)
                        ~t.indexOf(s) ? h.config[s] = te(d[s]).map(m).concat(h.config[s]) : void 0 === n[s] && (h.config[s] = d[s])
                }
                q("onParseConfig")
            }(),
            H(),
            function() {
                if (h.input = h.config.wrap ? u.querySelector("[data-input]") : u,
                !h.input)
                ...
                h._input = h.input,
                h.config.altInput && (h.altInput = ue(h.input.nodeName, h.input.className + " " + h.config.altInputClass),
                h._input = h.altInput,
            ...
            function() {
                ...
                Object.defineProperty(h, "showTimeInput", {
                    ...
                    set: function(e) {
                        h._showTimeInput = e,
                        h.calendarContainer && se(h.calendarContainer, "showTimeInput", e),
                        h.isOpen && L()
                    }
                })
            }(),
            ...
            h.isMobile || function() {
                ...
                if (h.calendarContainer = ue("div", "flatpickr-calendar"),
                h.calendarContainer.tabIndex = -1,
                !h.config.noCalendar) {
                    if (e.appendChild((h.monthNav = ue("div", "flatpickr-months"),
                    h.yearElements = [],
                    h.monthElements = [],
                    h.prevMonthNav = ue("span", "flatpickr-prev-month"),
                    h.prevMonthNav.innerHTML = h.config.prevArrow,
                    h.nextMonthNav = ue("span", "flatpickr-next-month"),
                    ...
                    Object.defineProperty(h, "_hidePrevMonthArrow", {
                        ...
                        set: function(e) {
                            h.__hidePrevMonthArrow !== e && (se(h.prevMonthNav, "disabled", e),
                    ...
                    Object.defineProperty(h, "_hideNextMonthArrow", {
                        ...
                        set: function(e) {
                            h.__hideNextMonthArrow !== e && (se(h.nextMonthNav, "disabled", e),
                    ...
                    G(),
                    h.monthNav)),
                    h.innerContainer = ue("div", "flatpickr-innerContainer"),
                    h.config.weekNumbers) {
                        var t = function() {
                            h.calendarContainer.classList.add("hasWeeks");
                            var e = ue("div", "flatpickr-weekwrapper");
                            e.appendChild(ue("span", "flatpickr-weekday", h.l10n.weekAbbreviation));
                    ...
                    h.rContainer = ue("div", "flatpickr-rContainer"),
                    h.rContainer.appendChild(T()),
                    h.daysContainer || (h.daysContainer = ue("div", "flatpickr-days"),
                ...
                h.config.enableTime && e.appendChild(function() {
                    ...
                    h.timeContainer = ue("div", "flatpickr-time"),
                    h.timeContainer.tabIndex = -1;
                    var e = ue("span", "flatpickr-time-separator", ":")
                      , t = me("flatpickr-hour");
                    h.hourElement = t.childNodes[0];
                    var n = me("flatpickr-minute");
                    if (h.minuteElement = n.childNodes[0],
                    h.hourElement.tabIndex = h.minuteElement.tabIndex = -1,
                    h.hourElement.value = Q(h.latestSelectedDateObj ? h.latestSelectedDateObj.getHours() : h.config.time_24hr ? h.config.defaultHour : function(e) {
                        switch (e % 24) {
                        case 0:
                        case 12:
                            return 12;
                    ...
                    h.minuteElement.value = Q(h.latestSelectedDateObj ? h.latestSelectedDateObj.getMinutes() : h.config.defaultMinute),
                    ...
                    h.config.enableSeconds) {
                        ...
                        var a = me("flatpickr-second");
                        h.secondElement = a.childNodes[0],
                        h.secondElement.value = Q(h.latestSelectedDateObj ? h.latestSelectedDateObj.getSeconds() : h.config.defaultSeconds),
                        ...
                        h.timeContainer.appendChild(ue("span", "flatpickr-time-separator", ":")),
                        h.timeContainer.appendChild(a)
                    }
                    return h.config.time_24hr || (h.amPM = ue("span", "flatpickr-am-pm", h.l10n.amPM[X(11 < (h.latestSelectedDateObj ? h.hourElement.value : h.config.defaultHour))]),
                    h.amPM.title = h.l10n.toggleTitle,
                    h.amPM.tabIndex = -1,
                    h.timeContainer.appendChild(h.amPM)),
                    h.timeContainer
                }()),
                se(h.calendarContainer, "rangeMode", "range" === h.config.mode),
                se(h.calendarContainer, "animate", !0 === h.config.animate),
                se(h.calendarContainer, "multiMonth", 1 < h.config.showMonths),
            ...
            function() {
                ...
                h.isMobile)
                    return function() {
                        ...
                        h.mobileInput = ue("input", h.input.className + " flatpickr-mobile"),
                ...
                void 0 !== h.daysContainer && (o(h.monthNav, "mousedown", r(Z)),
                o(h.monthNav, ["keyup", "increment"], n),
                o(h.daysContainer, "mousedown", r(K))),
                void 0 !== h.timeContainer && void 0 !== h.minuteElement && void 0 !== h.hourElement && (o(h.timeContainer, ["increment"], g),
                o(h.timeContainer, "blur", g, {
                    capture: !0
                }),
                o(h.timeContainer, "mousedown", r(s)),
    ...
    return pe.defaultConfig = C,
    pe.l10ns = {
        en: Object.assign({}, ie),
        default: Object.assign({}, ie)
    },
    pe.localize = function(e) {
        pe.l10ns.default = Object.assign({}, pe.l10ns.default, e)
    }
    ,
    pe.setDefaults = function(e) {
        pe.defaultConfig = Object.assign({}, pe.defaultConfig, e)
    }
    ,
    pe.parseDate = re({}),
    pe.formatDate = oe({}),
